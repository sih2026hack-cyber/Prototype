...
const STEMS = [
  ...
  'idiot', 'stupid', 'moron', 'dumbass', 'scumbag',
...
// Tamil/Hindi insults ("loosu" = crazy, "porukki" = thug, "naaye" = dog) are whole words only.
const EXACT = ['dick', 'dickhead', 'gandu', 'lund', 'kuthi', 'kudhi', 'ஓத்தா', 'loosu', 'lusu', 'losu', 'porukki', 'naaye', 'naye', 'pagal', 'kamina', 'kameena', 'லூசு', 'பொறுக்கி', 'நாயே', 'moodevi', 'peedai', 'மூதேவி'];
